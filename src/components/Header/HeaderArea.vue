<template>
  <header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadown-none">
    <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
      <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
        <!--
        <button
          class="z-999999 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden"
          @click="toggleSidebar"
        >
        -->
        <button
        ...
        <router-link class="block flex-shrink-0 lg:hidden" to="/">
          <img src="@/assets/logo_transparente_small.png" alt="PerúAgro" />
        </router-link>
      </div>
      <div class="hidden sm:block">
        <form action="" method="POST">
          <div class="relative">
            ...
            <input type="text" placeholder="Criterio de búsqueda"
